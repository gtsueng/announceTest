...
MAP_VARS = ["@type", "name", "author", "description", "datePublished", "identifier", "journalName", "journalNameAbbrev", "url"]

# when code is exported, import becomes relative
try:
    from covid19_announcements.parser import load_annotations as parser_func
except ImportError:
...
class AnnouncementUploader(biothings.hub.dataload.uploader.BaseSourceUploader):
    ...
    def load_data(self, data_folder):
        self.logger.info("No data to load from file for covid19_announcements")
        return parser_func()
